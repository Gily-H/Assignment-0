...
const countOfNumsWithinARange = require("./countOfNumsWithinARange");
const { expect } = require("chai");

describe("the countOfNumsWithinARange(nums, start, end) function", function() {

  it("should return a finite value", function() {
    let submittedSolution = countOfNumsWithinARange([1,2,3], 2, 10);
  ...
  it("should return a value that indicates the total amount of numbers that fall between start and end, inclusive", function() {
    let submittedSolution = countOfNumsWithinARange([7,8,9,10,11], 1, 6);
  ...
  it("should pass auxillary test cases", function() {
    ...
    let submittedSolution = countOfNumsWithinARange;
  ...
  it("should not conduct mutative operations on the input array", function() {
    ...
    countOfNumsWithinARange(sampleNums, 20, 60);
